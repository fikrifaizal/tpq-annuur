...
if(isset($_POST['tambahform'])) {
  ...
  $query = "INSERT INTO santri(`nis`, `nama_lengkap`, `panggilan`, `tempat_lahir`, `tgl_lahir`, `jenjang_sekolah`, `kelas`,
            ...
            '$namaBapak', '$pekerjaanBapak','$namaIbu', '$pekerjaanIbu', '$telpWali', '$alamat', '$infakBulanan', 'AKTIF', '$getToday')";
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select class="form-select" name="infak" id="infak" required>
        <option value="" selected disabled>Pilih Infak Bulanan</option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <div class="row">
        ...
        <div class="col col-md-6 d-grid gap-2">
          <button type="submit" name="tambahform" class="btn btn-success btn-block">
