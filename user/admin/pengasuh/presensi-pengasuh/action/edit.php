...
if(isset($_GET['id'])) {
  ...
  $query = "SELECT * FROM `filter_presensi_pengajar` WHERE `id` LIKE '$id'";
  ...
  if(isset($_POST['edit'])) {
    ...
    $queryCount = "SELECT COUNT(`id`) as total FROM `filter_presensi_pengajar` WHERE `bulan` LIKE '$bulan' AND `tahun` LIKE '$tahun'";
    ...
    if($dataCount['total'] >= 1) {
      ...
      $query = "UPDATE `filter_presensi_pengajar` SET `bulan`='$bulan' WHERE `id` LIKE '$id'";
      $result = mysqli_query($conn, $query);
