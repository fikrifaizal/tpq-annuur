...
$query = "SELECT * FROM `filter_presensi_pengajar` WHERE `tahun` LIKE '$tahun'";
$result = mysqli_query($conn, $query);

$filterQuery = "SELECT DISTINCT `tahun` FROM `filter_presensi_pengajar` ORDER BY `tahun` ASC";
                  ...
                  <?php 
                    ...
                    while($data = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                      ...
                      <td>
                        ...
                        <a role="button" href="action/rekap.php?id=<?= $data['id']?>" class="btn btn-success btn-sm" target="_blank">
                          <span>Rekap</span>
                        </a>
                      </td>
                      <td>
